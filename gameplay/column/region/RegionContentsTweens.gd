...
# FLY TO PACK #
###############
static func init_tween_fly_to_pack(
	tween_to_init : Tween,
	fly_to_pack_graphic : Sprite2D, 
...
# BONK OFF PACK #
#################
static func init_tween_bonk_off_pack(
	tween_to_init : Tween,
	fly_to_pack_graphic : Sprite2D
) -> Tween:
	...
	var step_0_randomized_offset : Vector2 = position_offset_unrotated.rotated(
		randomized_upward_angle
	)
	var step_0_global_position : Vector2 = (
		fly_to_pack_graphic.global_position
		+ step_0_randomized_offset
	)
...
# REVEAL NEW ITEM #
###################
static func init_tween_reveal_new_item(
	tween_to_init : Tween,
	item_graphic : Sprite2D, 
	item_name : RichTextLabel,
	element_display : SixElementDisplay
) -> Tween:
